...
parser.add_argument("--print_dialects", "-d", action="store", type=str,
                    nargs="*", default=dialects,
                    help=("Generate lexicon files for"
                          " one or more specified dialects."))
parser.add_argument("--print_base", "-b", action="store_true",
                    help=("Generate a base lexicon file,"
